...
insert  into `l_admin`(`id`,`username`,`name`,`email`,`password`,`remember_token`,`created_at`,`updated_at`) values (1,'lisonglin','李松林','lisonglin@sina.cn','4600648ddf7b53aee02bbb3508a1fd45','YR5xDdQPNNpWR4C8vSjdjeKu3X2dJGTPfUlsLZkv',NULL,'2016-07-21 08:14:55'),(2,'lisonglinds','的撒','lisonglin@sina.com','4600648ddf7b53aee02bbb3508a1fd45',NULL,NULL,NULL);
...
CREATE TABLE `l_course` (
  ...
  `sourse_knob` int(11) DEFAULT NULL COMMENT '课程节',
...
insert  into `l_course`(`id`,`uid`,`type_id`,`click_id`,`course_name`,`course_type`,`course_type_seo_title`,`course_price`,`course_picture`,`course_mins`,`sourse_knob`,`c_url`,`course_type_info`,`up_time`,`click`,`order`,`vid`,`vedio_url`,`is_del`,`vedio_name`) values (1,1,1,2,'测试','数学','攀枝花实验小学数学','12.00','/home/images/14673665481539.png',NULL,9,NULL,'<img src=\"images/1468507179_3834.jpg\" alt=\"\" /> ',NULL,0,1,1,'http://www.baidu.com',0,'测试课程');
...
insert  into `l_coursetype`(`id`,`type_id`,`mid`,`course_type`,`course_type_title`,`course_type_picture`,`type_click`,`type_url`) values (1,1,1,'数学','攀枝花实验小学数学','/home/images/14673665481539.png',2,NULL),(2,2,NULL,'语文','攀枝花实验小学语文','/home/images/14673665481539.png',0,NULL),(3,1,NULL,'数学','上海教育版 数学','/home/images/14625104188353.jpg',3213,NULL),(4,3,NULL,'英语','三年级下学期外研社 一年级起英语','/home/images/211.jpg',0,NULL),(5,3,NULL,'英语','五年级下学期牛津译林版英语','/home/images/210.jpg',0,NULL),(6,3,NULL,'英语','六年级下学期人教新版英语','/home/images/209.jpg',2,NULL),(7,4,NULL,'物理','初中物理实验系列（一）','/home/images/collection90.jpg',24,NULL),(8,4,NULL,'物理','初中物理实验系列（二）','/home/images/collection91.jpg',0,NULL),(9,5,NULL,'化学','初中化学实验系列（一）','/home/images/collection110.jpg',4,NULL),(10,2,NULL,'语文','中考必备：初中古诗词详解','/home/images/360495.jpg',33,NULL),(11,6,NULL,'初中语法','初中语法专项突破（一）','/home/images/355131.jpg',44,NULL),(12,3,NULL,'英语','中考英语考点各个击破系列二---满分完型','/home/images/350454.jpg',2,NULL);
